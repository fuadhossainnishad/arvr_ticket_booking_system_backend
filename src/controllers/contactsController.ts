...
import { getContactsService, postContactService } from "../services/contactsService";

export const postContactController = catchAsync(async(req:Request,res:Response)=>{
...
export const getContactController=catchAsync(async(req:Request,res:Response)=>{
